...
class _UpdateMyBankInfospageState extends State<UpdateMyBankInfospage> {
                  ...
                  ElevatedButton(
                    ...
                    child: BlocConsumer<UserProfileBloc, UserProfileState>(
                      listener: (context, state) {
                        if (state is UpdateBankAccountInfosLoading) {
                          setState(() {
                            isUpdating = true;
                          });
                        }
                        if (state is UpdateBankAccountInfosSuccess) {
                          setState(() {
                            isUpdating = false;
                          });
                        }
                        if (state is UpdateBankAccountInfosFailed) {
                          setState(() {
                            isUpdating = false;
                          });
                          showMessage(

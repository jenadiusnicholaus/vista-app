class GetMyFavPropertiesModel {
  int? count;
  dynamic next;
  dynamic previous;
  List<Results>? results;

  GetMyFavPropertiesModel({this.count, this.next, this.previous, this.results});

  GetMyFavPropertiesModel.fromJson(Map<String, dynamic> json) {
    count = json['count'];
    next = json['next'];
...
class Results {
  ...
  Results({this.id, this.user, this.property, this.createdAt, this.updatedAt});
